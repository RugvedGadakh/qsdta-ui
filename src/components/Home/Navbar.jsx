...
import { Home, Info, Award, Briefcase, Users, MessageCircle, Lock } from 'lucide-react'
...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { name: 'Login', icon: Lock, href: 'login' }  // Added Login button here
  ]
  ...
  return (
    <nav className={cn(
      "fixed w-full bg-white/70 text-gray-800 shadow-lg transition-all duration-300 z-50 backdrop-blur-sm", 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <span className="font-bold text-xl text-black">QSDTA</span>
          </div>
